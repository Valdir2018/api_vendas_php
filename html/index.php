    ...
    <header>
     ...
     <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="name_vendedor" name="nome" aria-describedby="Informe o nome do vendedor" 
        ...
        <div class="form-group">
          ...
          <button type="submit" class="btn btn-primary customer-button">CADASTRAR</button>
        </form>
     </div>
